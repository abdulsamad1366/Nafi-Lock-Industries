...
export default function Hero() {
  return (
    <section className="relative w-full bg-graphite-900 text-white overflow-hidden border-b border-steel-100/20">
      <div className="max-w-7xl mx-auto min-h-[520px] lg:min-h-[580px] grid grid-cols-1 lg:grid-cols-12 relative items-center">
        {/* Overlapping Off-Center Headline & Content */}
        <div className="lg:col-span-7 z-10 px-6 sm:px-12 py-16 lg:py-20 bg-graphite-900/90 lg:bg-transparent backdrop-blur-sm lg:backdrop-blur-none">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link
              ...
              className="bg-brass-600 hover:bg-brass-500 text-white font-space font-semibold px-6 py-3.5 rounded-sm flex items-center gap-2 text-sm tracking-wide transition-colors whitespace-nowrap"
            >
            ...
            <Link
              href="/dealer/apply"
              className="bg-transparent hover:bg-graphite-800 text-steel-300 hover:text-white font-space px-6 py-3.5 rounded-sm border border-steel-500/40 text-sm tracking-wide transition-colors whitespace-nowrap"
            >
