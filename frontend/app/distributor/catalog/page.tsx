      ...
      <div className="flex items-center gap-2 overflow-x-auto pb-2">
        {[
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full text-xs font-serif whitespace-nowrap transition-all ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredProducts.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="bg-surface border border-divider rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all flex flex-col justify-between group"
              >
                <div>
                  {/* Image Stage */}
                  ...
                  {/* Body Specs */}
                  <div className="p-5">
                    <h3 className="font-serif font-bold text-base text-primary mb-1 line-clamp-1">
                      {product.name}
                    </h3>

                    <div className="flex items-center gap-2 text-[11px] font-mono text-muted mb-3">
                    ...
                    <div className="bg-background border border-divider rounded-xl p-3 flex items-center justify-between mb-4">
                      <div>
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex items-center border border-divider rounded-xl overflow-hidden bg-background">
                      ...
                      <input
                        ...
                        className="w-12 text-center text-xs font-mono font-bold bg-transparent text-primary focus:outline-hidden"
                      />
                      <button
                        type="button"
                        onClick={() =>
